...
const EMPTY_MEDIA = new Set(['', 'default.jpg', 'default-logo.jpg']);
...
/**
 * URL untuk <img src>:
 * - kosong / default.jpg / null → /placeholder.png (frontend/public)
 * - http(s) → apa adanya
 * - /uploads/... → digabung VITE_API_URL
 */
export function mediaUrl(path) {
  ...
  // FIX: Gunakan API_BASE yang sudah di-set di .env
