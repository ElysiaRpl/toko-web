...
export const adminApi = {
  ...
  createPembeli: (payload) =>
    apiRequest('/api/admin/pembeli', { method: 'POST', body: JSON.stringify(payload) }), // ← TAMBAHKAN
  updatePembeli: (id, payload) =>
    apiRequest(`/api/admin/pembeli/${id}`, { method: 'PUT', body: JSON.stringify(payload) }), // ← TAMBAHKAN
  deletePembeli: (id) => apiRequest(`/api/admin/pembeli/${id}`, { method: 'DELETE' }), // ← TAMBAHKAN
...
export const pembeliApi = {
  ...
  createPembelian: (payload) => apiRequest('/api/users/pembelian', { method: 'POST', body: JSON.stringify(payload) }),
